  ...
  return (
    <div className="presentation">
      <div className="content">
        <p>
          Je suis titulaire d'une LICENCE en informatique et science du
          numérique de la spécialité bases de données à l’université virtuelle
          de côte d’ivoire.
        </p>
        ...
        <p className="formations">
          ...
          <span>
            formarion aux métiers du numérique, option développeur web et mobile
            à l'agence emploi jeunes | Août 2019
          </span>
        </p>
